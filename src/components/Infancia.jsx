...
function Infancia() {
  ...
  useEffect(() => {
    const savedLikes = JSON.parse(localStorage.getItem("infancia-likes") || "{}")
    setLike(savedLikes)

    getLikes().then((data) => {
      const counts = {}
      Object.entries(data).forEach(([key, count]) => {
        if (key.startsWith("infancia-")) {
  ...
  const dibujosInfancia = [
    { id: 1,  imagen: dibujo1,  año: 2016, tecnica: "colores escolares" },
    { id: 2,  imagen: dibujo2,  año: 2016, tecnica: "colores escolares" },
    { id: 3,  imagen: dibujo3,  año: 2016, tecnica: "Lápiz" },
    { id: 4,  imagen: dibujo4,  año: 2017, tecnica: "Lápiz" },
    { id: 5,  imagen: dibujo5,  año: 2018, tecnica: "Lápiz" },
    { id: 6,  imagen: dibujo6,  año: 2018, tecnica: "Lápiz" },
    { id: 7,  imagen: dibujo7,  año: 2018, tecnica: "Lápiz" },
    { id: 8,  imagen: dibujo8,  año: 2018, tecnica: "Lápiz" },
    { id: 9,  imagen: dibujo9,  año: 2018, tecnica: "Lápiz" },
    { id: 10, imagen: dibujo10, año: 2018, tecnica: "Lápiz" },
    { id: 11, imagen: dibujo11, año: 2018, tecnica: "Lápiz" },
    { id: 12, imagen: dibujo12, año: 2018, tecnica: "Lápiz" },
    { id: 13, imagen: dibujo13, año: 2016, tecnica: "Lápiz" },
    { id: 14, imagen: dibujo14, año: 2018, tecnica: "Lápiz" },
    { id: 15, imagen: dibujo16, año: 2018, tecnica: "Lápiz" },
    { id: 16, imagen: dibujo17, año: 2018, tecnica: "Lápiz" },
    { id: 17, imagen: dibujo18, año: 2018, tecnica: "Lápiz" },
    { id: 18, imagen: dibujo19, año: 2018, tecnica: "Lápiz" },
    { id: 19, imagen: dibujo20, año: 2018, tecnica: "Lápiz" },
    { id: 20, imagen: dibujo21, año: 2018, tecnica: "Lápiz" },
    { id: 21, imagen: dibujo22, año: 2019, tecnica: "Lápiz" },
    { id: 22, imagen: dibujo23, año: 2018, tecnica: "Lápiz" },
    { id: 23, imagen: dibujo24, año: 2018, tecnica: "Lápiz" },
    { id: 24, imagen: dibujo25, año: 2017, tecnica: "Lápiz" },
    { id: 25, imagen: dibujo26, año: 2017, tecnica: "colores escolares" },
  ]
  ...
  const handleToggleLike = async (id) => {
    const imagenId = `infancia-${id}`
    const accion = like[id] ? "unlike" : "like"
    const newLike = { ...like, [id]: !like[id] }
    setLike(newLike)
    localStorage.setItem("infancia-likes", JSON.stringify(newLike))
